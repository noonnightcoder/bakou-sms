 <?php
class Admin_buildings extends CI_Controller {
    ...
    */
    ...
    public function index()
    {
        ...
        $config['base_url'] = base_url().'index.php/admin/buildings';
        ...
        $data['counts']= $this->buildings_model->count_all();
        $data['result'] = $this->buildings_model->get_all($search, $config['per_page'], $limit_end);        
        ...
        //load the view
        $data['main_content'] = 'admin/buildings/list';
    ...
    public function add()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST')
        {
            ...
            $this->form_validation->set_rules('number_of_room', 'number_of_room', 'required');
            $this->form_validation->set_rules('building_description', 'building_description', '');
            ...
            if ($this->form_validation->run())
            {
                ...
                if($this->buildings_model->store_data($data_to_store)){
        ...
        //load the view
        $data['main_content'] = 'admin/buildings/add';
        $this->load->view('includes/template', $data);  
    }
    ...
    public function update()
    {
        ...
        //product data 
        $data['result'] = $this->buildings_model->get_by_id($id);
        //load the view
        $data['main_content'] = 'admin/buildings/edit';
        $this->load->view('includes/template', $data);            
