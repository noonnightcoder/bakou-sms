 <?php
class Admin_classroom_types extends CI_Controller {
    ...
    */
    ...
    public function index()
    {
        ...
        $config['base_url'] = base_url().'index.php/admin/classroom_types';
        ...
        $data['counts']= $this->classroom_types_model->count_all();
        ...
        //load the view
        $data['main_content'] = 'admin/classroom_types/list';
    ...
    public function update()
    {
        ...
        //product data 
        $data['result'] = $this->classroom_types_model->get_by_id($id);
        //load the view
