            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-content">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/admin/academic_programs/<?php echo $this->uri->segment(3); ?>" method="post" class="form-horizontal">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?php echo $res['academic_program_description']; ?></td>
                                <td class="td-actions">
