            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-header">
                        ...
                        <h3><a href="<?php echo base_url(); ?>index.php/admin/academics">Academics</a> / Update</h3>
                    </div> <!-- /widget-header -->

                    <div class="widget-content">

                        <form action="<?php echo base_url(); ?>index.php/admin/academics/update/<?php echo $this->uri->segment(4); ?>" method="post" id="edit-profile" class="form-horizontal">
                                <fieldset>
                                    <?php
                                        //flash messages
                                    ...
                                    <div class="control-group">                                         
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6" id="academic_name" name="academic_name" value="<?php echo $result['academic_name']; ?>">
                                        </div> <!-- /controls -->               
                                    </div> <!-- /control-group -->
                                    ...
                                    <div class="control-group">                                         
                                        ...
                                        <div class="controls">
                                            <textarea class="span6" id="academic_description" name="academic_description"><?php echo $result['academic_description']; ?></textarea>
                                        </div> <!-- /controls -->               
                                    </div> <!-- /control-group -->
