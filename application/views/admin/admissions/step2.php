            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-header">
                        ...
                        <h3>Step 2 of 7 -> Parent Personal Info</h3>
                    </div> <!-- /widget-header -->
                    ...
                    <div class="widget-content">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/admin/admission/parent/<?php echo $this->uri->segment(4); ?>" method="post" id="edit-profile" class="form-horizontal" enctype="multipart/form-data">
                            <fieldset>
                                <?php
                                    //flash messages
                                ...
                                <div class="form-actions">
                                    <button type="submit" class="btn btn-primary">Save, and go to step 3</button> 
