        ...
        <div class="span12">
                ...
                <div class="widget widget-plain">
                    ...
                    <div class="widget-content">
                        ...
                        <a href="<?php echo site_url("admin").'/classroom_types'; ?>" class="btn btn-large btn-info btn-support-ask">Show Classroom Type</a>
                    ...
                    <div class="widget-content">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/admin/classrooms/<?php echo $this->uri->segment(3); ?>" method="post" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label" for="radiobtns">Classrooms Name: </label>                                            
                                <div class="controls">
