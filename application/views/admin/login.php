...
<div class="account-container">
	...
	<div class="content clearfix">
		...
		<form action="<?php echo base_url(); ?>index.php/admin/login/validate_credentials" method="post">
			...
			<div class="login-fields">
				...
				<div class="field">
					...
					<input type="text" id="username" name="user_name" value="" placeholder="Username" class="login username-field" />
				</div> <!-- /field -->
