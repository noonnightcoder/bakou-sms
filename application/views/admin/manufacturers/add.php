            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-content">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/admin/manufacturers/add" method="post" id="edit-profile" class="form-horizontal">
                                <fieldset>
                                    <?php
                                        //flash messages
                                    ...
                                    <div class="control-group">                                         
                                        ...
                                        <div class="controls">
                                            <input type="text" class="span6" id="name" name="name" value="<?php echo set_value('name'); ?>">
                                        </div> <!-- /controls -->               
                                    </div> <!-- /control-group -->
