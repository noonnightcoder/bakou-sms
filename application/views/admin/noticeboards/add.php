            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-header">
                        ...
                        <h3><a href="<?php echo base_url(); ?>index.php/admin/noticeboards">Noticeboards</a> / Add New</h3>
                    </div> <!-- /widget-header -->

                    <div class="widget-content">

                        <form action="<?php echo base_url(); ?>index.php/admin/noticeboards/add" method="post" id="edit-profile" class="form-horizontal">
                            <fieldset>
                                <?php
                                    //flash messages
                                ...
                                <div class="control-group">                                         
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6" id="notice_title" name="notice_title" value="<?php echo set_value('notice_title'); ?>">
                                    </div> <!-- /controls -->               
                                </div> <!-- /control-group -->
                                ...
                                <div class="control-group">                                         
                                    ...
                                    <div class="controls">
                                        <textarea class="span6" id="notice_description" name="notice_description"><?php echo set_value('notice_description'); ?></textarea>
                                    </div> <!-- /controls -->               
                                </div> <!-- /control-group -->
