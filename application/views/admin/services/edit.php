            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-content">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/admin/services/update/<?php echo $this->uri->segment(4); ?>" method="post" id="edit-profile" class="form-horizontal">
                            <fieldset>
                                <?php
                                    //flash messages
                                ...
                                <div class="control-group">                                         
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6" id="service_name" name="service_name" value="<?php echo $result['service_name']; ?>">
                                    </div> <!-- /controls -->               
                                </div> <!-- /control-group -->
                                ...
                                <div class="control-group">                                         
                                    ...
                                    <div class="controls">
                                        <textarea class="span6" id="service_description" name="service_description"><?php echo $result['service_description']; ?></textarea>
                                    </div> <!-- /controls -->               
                                </div> <!-- /control-group -->
