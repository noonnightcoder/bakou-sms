            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-header">
                        ...
                        <h3><a href="<?php echo base_url(); ?>index.php/admin/staffs">Staffs</a> / Add New</h3>
                    </div> <!-- /widget-header -->
                    ...
                    <div class="widget-content">
                        ...
                        ?>
                        <form action="<?php echo base_url(); ?>index.php/admin/staffs/add" method="post" id="edit-profile" class="form-horizontal">
                            <fieldset>
                                <?php
                                    //flash messages
                                ...
                                echo '<div class="control-group">';
                                  ...
                                  echo '<div class="controls">';
                                    echo form_dropdown('position_id', $options_position, set_value('position_id'), 'class="span2"');
                                  echo '</div>';
                                echo '</div>';
                                ?>
                                ...
                                <div class="control-group">                                         
                                    ...
                                    <div class="controls">
                                        <input type="text" class="span6" id="email" name="email" value="<?php echo set_value('email'); ?>">
                                    </div> <!-- /controls -->               
                                </div> <!-- /control-group -->
                                ...
                                <div class="control-group">                                         
                                    ...
                                    <div class="controls">
                                        <textarea class="span6" id="staff_description" name="staff_description"><?php echo set_value('staff_description'); ?></textarea>
                                    </div> <!-- /controls -->               
                                </div> <!-- /control-group -->
