            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-header">
                        ...
                        <h3><a href="<?php echo base_url(); ?>index.php/admin/students">Students</a> / Add New</h3>
                    </div> <!-- /widget-header -->

                    <div class="widget-content">

                        <form action="<?php echo base_url(); ?>index.php/admin/students/add" method="post" id="edit-profile" class="form-horizontal" enctype="multipart/form-data">
                            <fieldset>
                                <?php
                                    //flash messages
