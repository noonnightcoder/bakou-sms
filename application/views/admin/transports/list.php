            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-content">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/admin/transports" method="post" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label" for="radiobtns">Transport Name: </label>                                            
                                <div class="controls">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td><?php echo $res['route_fare']; ?></td>
                                <td><?php echo $res['number_of_vehicle']; ?></td>
                                <td><?php echo $res['transport_description']; ?></td>
                                <td class="td-actions">
