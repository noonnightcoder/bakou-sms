          ...
          <div class="row">
            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-header">
                        ...
                        <h3><a href="<?php echo base_url(); ?>index.php/admin/vehicles/detail/<?php echo $this->uri->segment(4).'/'.$this->uri->segment(5); ?>">Membership</a> / Student Detail</h3>
                    </div> <!-- /widget-header -->
            ...
            <div class="span12">
                ...
                <div class="widget">
                    ...
                    <div class="widget-header">
                        <i class="icon-pushpin"></i>
                        <h3><a href="<?php echo base_url(); ?>index.php/admin/vehicles/detail/<?php echo $this->uri->segment(4).'/'.$this->uri->segment(5); ?>">Membership</a> / Membership Detail</h3>
                    </div> <!-- /widget-header -->
