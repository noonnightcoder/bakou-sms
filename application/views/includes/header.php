  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li <?php if(($this->uri->segment(2) == 'school') or ($this->uri->segment(2) == 'buildings') or ($this->uri->segment(2) == 'staffs') or ($this->uri->segment(2) == 'faculties') or ($this->uri->segment(2) == 'services')) { ?> class="dropdown active" <?php }else{ ?> class="dropdown" <?php } ?>><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-list"></i><span>Setting</span> <b class="caret"></b></a>
          <ul class="dropdown-menu">
